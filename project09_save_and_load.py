...
for filename in filenames:
    ...
    for i in range(batch_size):
        ...
        data_set = np.vstack((data_set, S.reshape(-1)))
        ############################################################################
    ...
    for i in range(test_batch_size):
        ...
        # print(S_norm.shape)
        # data_set.append(S_norm.reshape(-1))
        test_set = np.vstack((test_set, S.reshape(-1)))
...
with tf.Session() as sess:
    ...
    saver.restore(sess, "/home/sukhoon/Git/basic-machinelearning/sav/model.ckpt")
    ...
    for epoch in range(training_epochs):
        ...
        save_path = saver.save(sess, "/home/sukhoon/Git/basic-machinelearning/sav/model.ckpt")
